...
public class CategoryControllerIntTest {
    ...
    public void setup() {
        ...
        final CategoryController categoryController = new CategoryController(categoryService);
    ...
    public void createCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(post(ENDPOINT)
                .contentType(APPLICATION_JSON_UTF8)
                .content(TestUtils.convertObjectToJsonBytes(categoryDTO)))
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get(ENDPOINT + "?sort=id,desc"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
                .andExpect(jsonPath("$.content[*].id").value(hasItem(category.getId().intValue())))
    ...
    public void getCategory() throws Exception {
        ...
        // Get the category
        restCategoryMockMvc.perform(get(ENDPOINT + "/{id}", category.getId()))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void getNonExistingCategory() throws Exception {
        // Get the category
        restCategoryMockMvc.perform(get(ENDPOINT + "/{id}", Long.MAX_VALUE))
    ...
    public void updateCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(put(ENDPOINT)
                .contentType(APPLICATION_JSON_UTF8)
                .content(TestUtils.convertObjectToJsonBytes(categoryDTO)))
                .andExpect(status().isOk());
    ...
    public void deleteCategory() throws Exception {
        ...
        // Get the category
        restCategoryMockMvc.perform(delete(ENDPOINT + "/{id}", category.getId())
